...
const pastQuestionIndex = [
    ...
    { no: 126, format: 'simulator', category: 'fundamentals', key: 'formalmethod', source: 'R6春 午前II問23', title: '形式手法' },
    ...
    { no: 142, format: 'simulator', category: 'fundamentals', key: 'itgeneral', source: 'R6春 午前II問25', title: 'IT全般統制' },
    // --- ネットワーク (35) ---
    ...
    { no: 111, format: 'simulator', category: 'network', key: 'tls13suite', source: 'R5秋 午前II問2', title: 'TLS 1.3の暗号スイート' },
